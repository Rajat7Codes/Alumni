        ...
        public void onBindViewHolder(final MyViewHolder holder, final int listPosition) {
            ...
            holder.feedCard.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    intent.putExtra("postId", allPosts.get( holder.getAdapterPosition()).getId());
                    intent.putExtra("userName", allPosts.get( holder.getAdapterPosition()).getUser().getName());
                    intent.putExtra("userPic", allPosts.get( holder.getAdapterPosition()).getUser().getPic());
