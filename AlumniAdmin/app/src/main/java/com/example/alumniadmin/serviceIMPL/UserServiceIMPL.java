...
public class UserServiceIMPL implements UserService {
    ...
    @Override
    public void getAdminByIdAndPassword(@NonNull CallBack<Admin> callback, String mail, String password) {
        FirebaseDatabase.getInstance().getReference().child("admin").child(mail)
